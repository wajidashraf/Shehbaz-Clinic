...
const faqCopy = {
  ...
  ur: {
    ...
    description:
      "دانتوں کے معائنے، علاج اور اپائنٹمنٹس سے متعلق عام سوالات کے مفید جوابات۔",
    items: [
      {
        question:
          "دانتوں کے معائنے کے لیے مجھے کتنی بار ڈینٹسٹ کے پاس جانا چاہیے؟",
        answer:
          "دانتوں کا باقاعدہ معائنہ منہ کی صحت سے متعلق مسائل کو جلد پہچاننے میں مدد دیتا ہے۔ تجویز کردہ وقفہ آپ کے دانتوں کی حالت اور علاج کی ضروریات کے مطابق مختلف ہو سکتا ہے۔",
      },
      {
        question: "کیا دانتوں کا علاج تکلیف دہ ہوگا؟",
        answer:
          "آرام کا انحصار طریقۂ علاج اور آپ کی انفرادی حالت پر ہوتا ہے۔ ضرورت کے وقت علاج کو زیادہ آرام دہ بنانے کے لیے ڈینٹسٹ درد کم کرنے یا مقامی بے حسی کے مناسب طریقے استعمال کر سکتے ہیں۔",
      },
      {
        question: "دانتوں کے علاج میں عموماً کتنا وقت لگتا ہے؟",
        answer:
          "علاج کا وقت طریقۂ کار کے مطابق مختلف ہوتا ہے۔ معمول کا معائنہ یا صفائی نسبتاً کم وقت لے سکتی ہے، جبکہ روٹ کینال، بریسز یا بحالی کے علاج کے لیے زیادہ وقت یا متعدد ملاقاتیں درکار ہو سکتی ہیں۔",
      },
      {
        question: "مجھے اپنی ڈینٹل اپائنٹمنٹ کے لیے کیسے تیاری کرنی چاہیے؟",
        answer:
          "دانتوں یا طبی معلومات ساتھ لائیں اور ڈینٹسٹ کو اپنے خدشات، علامات، ادویات یا سابقہ علاج کے بارے میں بتائیں تاکہ آپ کی حالت کا مناسب جائزہ لیا جا سکے۔",
      },
    ],
  },
} as const;
      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-9 max-w-4xl space-y-3 sm:mt-10 sm:space-y-4">
          {content.items.map((faq) => (
            ...
            >
              <summary
                className={`flex cursor-pointer list-none items-center justify-between gap-5 px-5 py-5 marker:hidden sm:px-6 ${isRtl ? "text-right" : "text-left"}`}
              >
              ...
              <div
                className={`border-t border-[var(--line)] px-5 pb-5 pt-4 sm:px-6 ${isRtl ? "text-right" : "text-left"}`}
              >
